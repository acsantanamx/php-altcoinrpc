...
namespace DOne\Altcoin\Tests\Responses;
...
class AltcoindResponseTest extends TestCase
{
    /**
     * Set up test.
     *
    ...
    public function setUp(): void
    {
        ...
        $this->response = new AltcoindResponse($this->guzzleResponse);
    ...
    {
        $response = new AltcoindResponse($this->rawTransactionError());
    ...
    public function testSerialize(): void
    {
        ...
        $serialized = sprintf(
            'C:%u:"%s":%u:{%s}',
            strlen(AltcoindResponse::class),
            AltcoindResponse::class,
