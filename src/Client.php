...
use DOne\Altcoin\Traits\HandlesAsync;
...
class Client
{
    ...
    /**
     * Makes async request to Altcoin Core.
     *
     * @param string        $method
     * @param mixed         $params
    ...
    {
        return 'DOne\\Altcoin\\Responses\\AltcoindResponse';
    }
